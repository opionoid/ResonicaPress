...
| 056 | 白の狂騒     |  3  |  1   |  340 | 貫通．会心時発狂                                                                                                           |
| 057 | 粉雪の道草   |  3  |  9   |  220 | 即時．反撃のみ．対象のターン終了時に発動                                                                                   |
| 058 | 白雪の狂奔   |  3  |  1   |  260 | AoE．会心率+6．会心時発狂                                                                                                  |
| 059 | 流氷の奔流   |  3  |  0   |  300 | AoE．命中するたび射程+1                                                                                                    |
| 060 | 氷海の剔抉   |  3  |  1   |  260 | 貫通．射程 0 のみ必ず会心しスネア．連続使用不可                                                                            |
...
| 070 | 白雨         |  3  |  1   |  260 | AoE．会心時発狂                                                                                                            |
| 071 | 満開         |  3  |  1   |  400 | 貫通．「六花」以外のスキル使用時に「六花」を 1 スタック得る（最大 6）．最大スタックでのみ使用可能．散華に切り替える        |
| 072 | 散華         |  1  |  1   |  200 | 貫通．どのスキルを使用しても「六花」を獲得できない．これ単体ではセットできない                                             |
| 073 | 狂牢         |  3  |  1   |  260 | スネア．発狂                                                                                                               |
| 074 | 吹雪         |  3  |  3   |  280 | AoE                                                                                                                        |
| 075 | 白一閃       |  3  |  1   |  220 | 即時．貫通                                                                                                                 |
| 076 | 白の戦場     |  3  |  1   |  300 | 貫通．リープ．リープ後，別の対象へ威力―160 で一度だけ再発動可能．同一対象に複数回命中する                                  |
| 84  | 白葬         |  3  |  1   |  340 | 貫通．対象が防御や回避をしなければ会心率+12                                                                                |
| 89  | 虚空の来訪者 |  3  |  1   |  400 | 貫通．命中対象にリープして互いにスネアを付与してもよい                                                                     |
