...
| 004 | 六花             |  1  |  1   |    0 | 貫通．他のスキル使用時「六花」を 1 得て，1 スタックにつき六花の威力+30．最大スタック（6）では会心する                      |
...
| 074 | 吹雪             |  3  |  3   |  240 | AoE．弓スキルとしても使用可能                                                                                              |
| 075 | 白一閃           |  3  |  1   |  180 | 即時．貫通                                                                                                                 |
| 076 | 白の戦場         |  3  |  1   |  200 | 貫通．リープ．リープ後，別の対象へ威力―100 で一度だけ再発動可能．同一対象に複数回命中する                                  |
| 84  | 白葬             |  3  |  1   |  300 | 貫通．対象が防御や回避をしなければ会心率+12                                                                                |
| 88  | ヴァルケインの拳 |  4  |  1   |  300 | 貫通．AoE．スネア中の相手には会心率+12．槍スキルとしても使用可能                                                           |
| 89  | 虚空の来訪者     |  4  |  1   |  320 | 貫通．命中対象にリープして互いにスネアを付与してもよい                                                                     |
| S01 | 無顔の正義       |  0  |  1   |  100 |                                                                                                                            |
| S01 | 六花狂咲         |  0  |  0   |    0 | 即時．「六花」を最大にする．散華後に使用した場合，HP200 を失うが散華を解除して「六花」を獲得する                           |
| S02 | 千本槍           |  4  |  1   |  100 | 貫通．4 回発動する．発動のたび，対象を変更してもよい                                                                       |
| S02 | 破鏡不照         |     |      |      |                                                                                                                            |
| S02 | 蒼花葬輪         |     |      |      |                                                                                                                            |
